...
| `hover_second_image` | Второе фото при наведении | checkbox | `true` | Desktop hover → 2-е фото; только при `show_photos` |
...
- [ ] `show_photos`, `hover_second_image`, `show_prices`, `show_categories`, `show_product_sort`, `show_all_results`, `show_out_of_stock_badge`
